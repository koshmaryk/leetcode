<h2><a href="https://leetcode.com/problems/mice-and-cheese/description/">2725. Mice and Cheese</a></h2><h3>Medium</h3><hr><p>There are two mice and <code>n</code> different types of cheese, each type of cheese should be eaten by exactly one mouse.</p>
